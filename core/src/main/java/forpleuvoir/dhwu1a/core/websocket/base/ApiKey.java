...
public class ApiKey {
    ...
    public static final String MESSAGE_CHAIN = "messageChain";
    ...
    public static final String IS_BY_BOT = "isByBot";
    ...
    public static final String CONFESS_TALK = "confessTalk";
    public static final String ALLOW_MEMBER_INVITE = "allowMemberInvite";
    public static final String AUTO_APPROVE = "autoApprove";
    public static final String ANONYMOUS_CHAT = "anonymousChat";
